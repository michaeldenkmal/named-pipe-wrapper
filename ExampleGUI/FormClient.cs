...
namespace ExampleGUI
{
    ...
    {
        private readonly NamedPipeClient _client = new NamedPipeClient(Constants.PIPE_NAME,".");
        ...
        private void OnServerMessage(NamedPipeConnection connection, string message)
        {
